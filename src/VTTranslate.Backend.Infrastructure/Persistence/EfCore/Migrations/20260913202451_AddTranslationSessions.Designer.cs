...
namespace VTTranslate.Backend.Infrastructure.Persistence.EfCore.Migrations
{
    ...
    [Migration("20260913202451_AddTranslationSessions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VTTranslate.Backend.Domain.Entities.ProviderAccessGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_provider_access_grants_device");

                    b.HasIndex("AccountId", "IssuedAt")
                        .HasDatabaseName("ix_provider_access_grants_account_time");

                    b.ToTable("provider_access_grants", (string)null);
                });
            ...
            modelBuilder.Entity("VTTranslate.Backend.Domain.Entities.TranslationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_translation_sessions_account");

                    b.HasIndex("DeviceId");

                    b.HasIndex("AccountId", "ClientSessionId")
                        .IsUnique()
